...
?>
    <div id="landing">
        ...
        <div >
            <img src="./media/tanks2000.png" alt="large lp tanks" class="landing-imgs"/>
        </div>

        <div class="landing-div">
            <h3>Call us or click the link today to become a customer 
                or to let us know how we can serve you better!
            </h3>
            <a href="/brp/php/contact.php">Connect with us here!</a>
