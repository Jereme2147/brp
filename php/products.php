...
<div class="products">
    ...
    <div class="product-section" id="gas-logs">
        ...
        <h3>Gas Logs</h3>
        <ul>
            <a href="http://www.rhpeterson.com/" target="_blank"><li>Peterson Real Fyre</li></a>
            <a href="http://www.empirecomfort.com/brand-family/fireplaces/" target="_blank"><li>Empire</li></a>
            <a href="https://www.majesticproducts.com/Browse/Options-and-Accessories/Gas-Log-Sets.aspx#" target="_blank"><li>Majestic</li></a>
            <a href="https://www.monessenhearth.com/Vent-Free-Gas-Log-Sets.aspx" target="_blank"><li>Monessen</li></a>
            <a href="http://whitemountainhearth.com/products/log-sets-and-burners/" target="_blank"><li>White Mountain Hearth</li></a>
            <a href="http://goldenblountinc.com/catalog/vented-gas-logs/" target="_blank"><li>Golden Blunt</li></a>
        </ul>
    </div>
        <div class="product-section" id="gas-inserts">
            ...
            <ul>
                ...
                <a href="https://napoleonfireplaces.com/" target="_blank"><li>Napoleon</li></a>
                <a href="http://whitemountainhearth.com/products/vent-free/inserts/" target="_blank"><li>Empire</li></a>
                <a href="http://superiorfireplaces.us.com/products/t/fireplace-inserts" target="_blank"><li>Superior</li></a>
            </ul>
    </div>
        ...
        <div class="product-section" id="gas-grill">
            ...
            <ul>
                ...
                <a href="http://www.primogrill.com/en-us/" target="_blank"><li>Primo</li></a>
                <a href="https://www.campchef.com/" target="_blank"><li>Camp Chef</li></a>
                <a href="http://broilmaster.com/" target="_blank"><li>Broilmaster</li></a>
            </ul>
        </div>
        <div class="product-section" id="free-standing">
            ...
            <ul>
                ...
                <a href="http://whitemountainhearth.com/products/cast-iron-stoves/" target="_blank"><li>White Mountain Hearth</li></a>
                <a href="http://napoleonfireplaces.com/products_categories/direct-vent-gas-stoves/" target="_blank"><li>Napoleon</li></a>
                <a href="https://jotul.com/us/" target="_blank"><li>Jotul</li></a>
            </ul>
        </div>
        ...
        <div class="product-section" id="waterheater-tankless">
            ...
            <ul>
                ...
                <a href="https://www.noritz.com/" target="_blank"><li>Noritz</li></a>
            </ul>
        </div>
        <div class="product-section" id="outdoor-patio">
            ...
            <ul>
                ...
                <a href="#" target="_blank"><li>Twin Eagles Heating</li></a>
            </ul>
        </div>
        ...
        <div class="product-section" id="vented-room">
            ...
            <ul>
                ...
                <a href="http://empirezoneheat.com/products/vented-wall-furnaces/b-vent-console-and-visual-flame-room-heaters/" target="_blank"><li>Empire</li></a>
        ...
        <div class="product-section" id="shop-heaters">
            ...
            <ul>
                ...
                <a href="http://www.mrheater.com/" target="_blank"><li>Mr Heater</li></a>
            </ul>
        </div>
        <div class="product-section" id="firebox">
            ...
            <ul>
                ...
                <a href="#" target="_blank"><li>Empire</li></a>
                <a href="http://superiorfireplaces.us.com" target="_blank"><li>Superior</li></a>
            </ul>
        </div>
