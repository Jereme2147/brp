...
<div id="contact">
    ...
    <div id="full-form">
        <form action="./mail.php" id="contact-form" method="POST">
            ...
            <input type="tel" id="phone" class="inputs"name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="Phone: 828-000-0000">
            <div id="user-info">
                ...
                <select name="Choose" id="dropdown">
                    <fieldset>
                        ...
                        <option name="need"value="learn">Learn about Propane pricing options</option>
